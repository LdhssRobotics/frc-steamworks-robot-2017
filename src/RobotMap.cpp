...
void RobotMap::init() {
	...
	rachetServo.reset(new Servo(2));

	// Drivetrain subsystem
	leftDrive.reset(new Victor(3));
	rightDrive.reset(new Victor(4));
	...
	gearLimitSwitch.reset(new DigitalInput(0));
	...
	// Shooter subsystem
	flywheelMotor.reset(new Victor(5));
