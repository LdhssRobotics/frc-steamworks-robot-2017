...
#define DRIVE_ENCODER_B_PORT 3
		...
		// Gear subsystem
#define GEAR_ENCODER_A_PORT 4
#define GEAR_ENCODER_B_PORT 5

#define GEAR_LIMIT_SWITCH_PORT 6

		// Shooter subsystem
#define SHOOTER_LEFT_LIMIT_SWITCH_PORT 7

#define SHOOTER_RIGHT_LIMIT_SWITCH_PORT 8

#define FLYWHEEL_ENCODER_1A_PORT 9
#define FLYWHEEL_ENCODER_1B_PORT 10

#define FLYWHEEL_ENCODER_2A_PORT 11
#define FLYWHEEL_ENCODER_2B_PORT 12
